...
if(isset($_POST['delete'])){
	$delId = $_GET['id'];
	$query = "DELETE FROM `action_list` WHERE id = '$delId'";
...
$query = "INSERT INTO `action_list`(`name`) VALUES ('$name')";
$result = $conn->query($query);
if($result){
...
<div class="w3-bar">
  <a href="#" class="w3-button w3-white w3-hover-white"><b>List of Actions</b></a> 
...
<div class="w3-card table">
			<table id="list" class="w3-table w3-striped w3-bordered w3-hoverable">
				...
				<?php 
					...
					<div class="dropdown">
						...
						<a href="edit_action.php?id=<?= $row['id']?> " class="logbtn w3-button w3-hover-light-grey">Edit</a>
						<form action="actions.php?id=<?= $row['id']?>" method="POST">
	...
	<div id="id01" class="modal"> 
		<form class="modal-content animate" action="actions.php" method="POST"> 
			<h2><center>Action Registration</center></h2>
